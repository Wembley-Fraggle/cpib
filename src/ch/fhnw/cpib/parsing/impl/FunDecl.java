...
public class FunDecl implements IFunDecl {
    ...
    public FunDecl(IToken fun, IToken ident, IParamList paramList,
            IToken returns, IStoDecl stoDecl, IFunDecl1 funDecl1,
            IFunDecl2 funDecl2, IFunDecl3 funDecl3, IToken consume4,
            ICpsCmd cpsCmd, IFunDecl4 funDecl4, IToken endFun) {
        this.fun = fun;
        this.ident = ident;
